...
MAT = {
    "bronze": make_mat("antique bronze", (0.47, 0.25, 0.12, 1), metallic=0.25, roughness=0.42),
    "bronze_hi": make_mat("warm bronze facet", (0.82, 0.48, 0.22, 1), metallic=0.2, roughness=0.34),
    "dark": make_mat("dark olive gunmetal", (0.08, 0.11, 0.09, 1), metallic=0.25, roughness=0.5),
    "jade": make_mat("jade glass core", (0.02, 0.55, 0.42, 1), roughness=0.18, emission=(0.02, 0.65, 0.48, 1), strength=0.45),
    "jade_hi": make_mat("bright jade glow", (0.18, 1.0, 0.78, 1), roughness=0.16, emission=(0.12, 1.0, 0.75, 1), strength=1.65),
    "shadow_jade": make_mat("deep teal glass", (0.0, 0.18, 0.16, 1), roughness=0.3, emission=(0.0, 0.28, 0.22, 1), strength=0.22),
    "edge": make_mat("dark ink edge", (0.025, 0.027, 0.025, 1), roughness=0.55),
}


def build_weapon():
    # Long faceted jade blade core.
    blade = [
        (-0.36, 0.25), (-0.25, -0.55), (-0.28, -2.8), (-0.12, -4.22),
        (0, -4.65), (0.12, -4.22), (0.28, -2.8), (0.25, -0.55), (0.36, 0.25),
    ]
    extruded_poly("single shared jade crystal blade", blade, 0.20, MAT["jade"])
    inner = [
        (-0.12, 0.05), (-0.07, -0.75), (-0.08, -3.22), (0, -4.1),
        (0.08, -3.22), (0.07, -0.75), (0.12, 0.05),
    ]
    ...
    guard = [
        (-0.75, 0.55), (-0.42, 0.95), (-0.16, 0.55), (0, 0.72),
        (0.16, 0.55), (0.42, 0.95), (0.75, 0.55), (0.46, 0.12),
        (0.18, 0.08), (0, -0.25), (-0.18, 0.08), (-0.46, 0.12),
    ]
    ...
    wing_l = [
        (-0.70, 0.40), (-1.25, 0.62), (-1.10, 0.30), (-1.45, 0.04),
        (-1.02, 0.02), (-0.72, 0.20),
    ]
    ...
    left_arc = [(-0.08, 1.24), (-0.42, 1.02), (-0.72, 0.58), (-0.54, 0.45), (-0.28, 0.84), (0, 1.02)]
...
def setup_scene():
    ...
    bpy.context.scene.world.color = (0.72, 0.82, 0.88)
    build_weapon()
...
def render_view(name, camera_location):
    ...
    bpy.context.scene.render.filepath = str(CANDIDATE_DIR / f"jade_arc_sword_variant_v2_{name}_candidate.png")
...
def main():
    ...
    print("JADE_ARC_SWORD_V2_RENDER_OK")
    print(CANDIDATE_DIR)
